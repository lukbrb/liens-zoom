...
from base_donnees import add_cm, add_td
from ui.UI_modif import Ui_Modificationlien
...
# TODO: Si aucune case remplie, désactiver les boutons
    ...
    def ajouter(self):
        ...
        if verif_cm and not verif_ent:  # Si toutes les cases remplies et checkbox CM cochée
            nom1 = str(nom)
            add_cm(nom1, url, DB_PATH)  # Ajoute le nom et l'URL à la base de données
